...
void testFile(std::size_t dataCount, const std::string dataToWrite, const std::string& filename) {
...
void testOnDemand(std::size_t dataCount, const std::string dataToWrite, const std::string& filename) {
